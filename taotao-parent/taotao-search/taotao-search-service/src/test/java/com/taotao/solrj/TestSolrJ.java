...
public class TestSolrJ {
    ...
    public void testAddDocument() throws Exception{
        ...
        SolrServer solrServer = new HttpSolrServer("http://192.168.30.100:8081/solr/collection1");
    ...
    public void deleteDocumentByQuery() throws Exception{
        //创建一个SolrServer对象，创建一个HttpSolrServer对象，需要指定solr服务的url
        SolrServer solrServer = new HttpSolrServer("http://192.168.206.10:8080/solr/collection1");
        //通过价格来删除文档
    ...
    @Test
    public void queryDocument_hig() throws Exception{
        //创建一个SolrServer对象，创建一个HttpSolrServer对象，需要指定solr服务的url
        SolrServer solrServer = new HttpSolrServer("http://192.168.206.10:8080/solr/collection1");
        //创建一个SolrQuery对象
        SolrQuery query = new SolrQuery();
